...
-- Soal 1.2 --
/*table 1*/
insert into customer values (1,'Ana','indonesia',25,1000);
insert into customer values (2,'Brian','india',28,1500);
insert into customer values (3,'Lucky','indonesia',30,1700);
insert into customer values (4,'Alex','australia',35,2000);
insert into customer values (5,'Ayu','indonesia',40,6200);
insert into customer values (6,'Chloe','singapore',35,6500);
insert into customer values (7,'John','us',29,1200);
insert into customer values (8,'Kevin','singapore',38,6000);
insert into customer values (9,'Aga','indonesia',45,6250);
insert into customer values (10,'Sean','singapore',21,3000);
insert into customer values (11,'Hana','indonesia',67,9000);
insert into customer values (12,'Cika','indonesia',25,11000);
insert into customer values (13,'Axel','india',24,5000);
insert into customer values (14,'Sonya','us',23,4300);
insert into customer values (15,'Ika','indonesia',38,8000);
insert into customer values (16,'Willy','australia',49,11000);
insert into customer values (17,'Michael','australia',21,7800);
insert into customer values (18,'Lea','indonesia',25,5600);
insert into customer values (19,'Kareem','india',50,7000);
insert into customer values (20,'Jane','us',46,6000);
select * from customer;
/*table 2*/
insert into unit values (1,'sharp',1500,'tv',11);
insert into unit values (2,'sharp',1000,'ac',11);
insert into unit values (3,'samsung',2000,'gadget',12);
insert into unit values (4,'lg',1000,'ac',12);
insert into unit values (5,'sanken',1200,'chiller',13);
insert into unit values (6,'oppo',1000,'gadget',14);
insert into unit values (7,'apple',3000,'gadget',14);
insert into unit values (8,'sharp',1000,'tv',11);
insert into unit values (9,'oppo',1200,'gadget',14);
insert into unit values (10,'lg',1000,'tv',13);
insert into unit values (11,'lg',1000,'tv',13);
insert into unit values (12,'sharp',1500,'ac',11);
insert into unit values (13,'sony',2000,'tv',13);
insert into unit values (14,'samsung',3000,'gadget',14);
insert into unit values (15,'samsung',1000,'ac',13);
insert into unit values (16,'sharp',3000,'tv',15);
insert into unit values (17,'aqua',1000,'tv',18);
insert into unit values (18,'samsung',1000,'gadget',20);
insert into unit values (19,'vivo',1000,'gadget',20);
insert into unit values (20,'sony',1800,'tv',11);
select * from unit;
/*table 3*/
insert into supplier values (11,'A','indonesia','tv',100);
insert into supplier values (12,'B','japan','gadget',100);
insert into supplier values (13,'C','korea','ac',100);
insert into supplier values (14,'c','singapore','chiller',100);
insert into supplier values (15,'D','indonesia','tv',100);
insert into supplier values (16,'E','indonesia','chille',100);
insert into supplier values (17,'F','indonesia','ac',100);
insert into supplier values (18,'G','indonesia','gadget',100);
insert into supplier values (19,'H','india','ac',100);
insert into supplier values (20,'I','korea','gadget',100);
insert into supplier values (20,'I','indonesia','tv',100);
insert into supplier values (11,'A','indonesia','ac',100);
insert into supplier values (12,'B','indonesia','tv',100);
insert into supplier values (13,'C','indonesia','ac',100);
insert into supplier values (14,'D','korea','tv',50);
insert into supplier values (15,'E','china','tv',20);
insert into supplier values (16,'F','indonesia','gadget',100);
insert into supplier values (17,'G','india','ac',80);
insert into supplier values (18,'H','indonesia','chiller',90);
insert into supplier values (19,'I','indonesia','tv',100);
select * from supplier;
/*table 4*/
insert into payment values (1,'2020-01-01',1,1,7500);
insert into payment values (2,'2020-01-02',2,3,8000);
insert into payment values (3,'2020-01-03',3,2,4000);
insert into payment values (4,'2020-01-04',4,4,1000);
insert into payment values (5,'2020-01-01',5,5,5000);
insert into payment values (6,'2020-01-02',6,6,7500);
insert into payment values (7,'2020-01-03',7,7,8900);
insert into payment values (8,'2020-01-03',8,8,1200);
insert into payment values (9,'2020-01-02',9,9,6700);
insert into payment values (10,'2020-01-01',11,10,5000);
insert into payment values (11,'2020-01-04',11,11,9000);
insert into payment values (12,'2020-01-06',10,12,10000);
insert into payment values (13,'2020-01-06',12,13,7600);
insert into payment values (14,'2020-01-03',13,14,2800);
insert into payment values (15,'2020-01-01',15,15,2900);
insert into payment values (16,'2020-01-07',15,16,7800);
insert into payment values (17,'2020-01-03',18,17,6600);
insert into payment values (18,'2020-01-05',19,18,8900);
insert into payment values (19,'2020-01-02',20,19,9000);
insert into payment values (20,'2020-01-01',9,12,10000);
select * from payment;
/*table 5*/
insert into shippmet values (11,'jakarta','indonesia','2020-01-01',200);
insert into shippmet values (12,'surabaya','indonesia','2020-01-02',300);
insert into shippmet values (13,'changi','singapore','2020-01-03',100);
insert into shippmet values (14,'guangzhou','china','2020-01-02',400);
insert into shippmet values (15,'tokyo','japan','2020-01-02',500);
insert into shippmet values (16,'jakarta','indonesia','2020-01-04',500);
insert into shippmet values (17,'surabaya','indonesia','2020-01-06',100);
insert into shippmet values (18,'lampung','indonesia','2020-01-09',400);
insert into shippmet values (19,'sydney','australia','2020-01-10',300);
insert into shippmet values (20,'mumbay','india','2020-01-10',200);
insert into shippmet values (21,'soul','korea','2020-01-08',600);
insert into shippmet values (22,'bandung','indonesia','2020-01-01',700);
insert into shippmet values (23,'surabaya','indonesia','2020-01-02',250);
insert into shippmet values (24,'jakarta','indonesia','2020-01-03',150);
insert into shippmet values (25,'wuhan','china','2020-01-02',180);
insert into shippmet values (26,'jakarta','indonesia','2020-01-07',300);
insert into shippmet values (27,'cirebon','indonesia','2020-01-08',700);
insert into shippmet values (28,'maluku','indonesia','2020-01-07',100);
insert into shippmet values (29,'papua','indonesia','2020-01-09',200);
insert into shippmet values (30,'bandung','indonesia','2020-01-10',400);
select * from shippmet ;

-- Soal 2.1 --
select address, count(shippment_id) as total_shippment, max(postal_fee) as max_fee, length(address) as karakter_address from shippmet group by address;
-- Soal 2.2 --
/*mengelompokkan jumlah customer dari masing-masing negara dengan usia diatas 25 tahun (table customer) 
yg negaranya menyediakan layanan pengiriman (table shippmet)*/
select addres as country, count(addres) as total_customer , max(age) as max_age from customer 
where age > 25 and addres in (select country from shippmet) 
group by addres order by addres;
...
-- mencari employee dengan salary diatas 5000 --
select * from employees where salary > 5000;
-- total employee dengan salary diatas 5000 setiap departement--
select department_id , count(employee_id) as total_employee from employees
where salary > 5000
group by department_id ;
-- rata-rata gaji setiap departement--
select department_id , round(avg(salary),0) as avg_salary from employees group by department_id order by department_id ;
